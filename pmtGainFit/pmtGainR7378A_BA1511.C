Int_t pmtGainR7378A_BA1511(){
  ...
  f2paramsFit[0] = 0.735788;//k
  f2paramsFit[1] = 0.165784;//a
  ...
  gain[0] = 1.87E+06; //  900 V
  gain[1] = 2.76E+06; //  950 V
  gain[2] = 3.98E+06; // 1000 V
  gain[3] = 5.95E+06; // 1050 V
  gain[4] = 8.06E+06; // 1100 V
