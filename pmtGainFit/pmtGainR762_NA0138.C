Int_t pmtGainR762_NA0138(){
  ...
  f2paramsFit[0] = 0.664846;//k
  f2paramsFit[1] = 0.210526;//a
  Int_t i = 0;
  for(i = 0;i<nn;i++){
  ...
  gain[0] = 3.52E+03; //  400 V
  gain[1] = 1.76E+04; //  500 V
  gain[2] = 6.86E+04; //  600 V
  gain[3] = 2.11E+05; //  700 V
  gain[4] = 5.45E+05; //  800 V
  gain[5] = 1.00E+06; //  900 V
  gain[6] = 1.35E+06; // 1000 V
  ...
  for(i = 0;i<13;i++){
    ...
    else if(hv_tt[i]>600 && hv_tt[i]<850)
