Int_t pmtGainR7378A_BA1513(){
  ...
  f2paramsFit[0] = 0.742609;//k
  f2paramsFit[1] = 0.163135;//a
  ...
  gain[0] = 2.11E+06; //  900 V
  gain[1] = 3.23E+06; //  950 V
  gain[2] = 4.68E+06; // 1000 V
  gain[3] = 6.95E+06; // 1050 V
  gain[4] = 9.25E+06; // 1100 V
