Int_t pmtGainR7378A_BA1512(){
  ...
  f2paramsFit[0] = 0.784792;//k
  f2paramsFit[1] = 0.132402;//a
  ...
  gain[0] = 1.68E+06; //  900 V
  gain[1] = 2.63E+06; //  950 V
  gain[2] = 3.95E+06; // 1000 V
  gain[3] = 5.65E+06; // 1050 V
  gain[4] = 8.19E+06; // 1100 V
